...
public class AppConfig {
  ...
  public static final String APP_DESCRIPTION = "This is a rest api for Demo application.";
  public static final Locale DEFAULT_LOCALE = Locale.FRENCH;
  public static final List<Locale> SUPPORTED_LOCALES = Collections.singletonList(Locale.FRENCH);
}
