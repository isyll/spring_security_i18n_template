...
public class LocaleInterceptor implements HandlerInterceptor {
  ...
  public boolean preHandle(
    ...
    if (localeResolver == null) {
      throw new IllegalStateException("No LocaleResolver found: not in a DispatcherServlet auth?");
    }
  ...
  private Locale determineLocale(
    ...
    if (AppMetadata.SUPPORTED_LOCALES.contains(locale)) {
      return locale;
    }

    return AppMetadata.DEFAULT_LOCALE;
  }
}
